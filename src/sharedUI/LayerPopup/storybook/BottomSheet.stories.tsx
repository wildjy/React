...
// Storybook 메타 설정
export default {
  title: 'UI/LayerPopup/BottomSheet',
...
const Template: StoryFn<typeof BottomSheet> = (args) => {
  ...
  return (
    <div className="w-full h-screen">
      <button onClick={toggleBottomSheet} className="p-2 text-white bg-blue-500">
      ...
      <BottomSheet {...args} isOpen={isOpen} OpenEvent={toggleBottomSheet}>
        ...
        <BottomSheet.Body>
          <p className="p-4">이곳은 BottomSheet의 본문 영역입니다. 다양한 콘텐츠를 넣어보세요.</p>
          <p className="p-4">스크롤 테스트를 위해 여러 줄을 추가해보세요.</p>
        ...
        <BottomSheet.Footer>
          <div className="flex justify-end gap-2 p-4">
            <button className="px-4 py-2 bg-gray-200 rounded-md" onClick={toggleBottomSheet}>
              취소
            </button>
            <button className="px-4 py-2 text-white bg-blue-500 rounded-md">확인</button>
          </div>
        </BottomSheet.Footer>
      </BottomSheet>
    </div>
