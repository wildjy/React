...
interface swiperProps {
  ...
  id?: number;
  image?: boolean;
  arrow?: boolean | { show: boolean; addClass?: string };
  pager?: boolean | { show: boolean; addClass?: string };
  onSlideChange?: (swiper: SwiperClass) => void;
}

export const CouponSwiperSlider: React.FC<swiperProps> = ({
  freeMode = true,
  loop = false,
  autoplay,
  delay = 2500,
  ...
  const pagination = {
    ...
    renderBullet: function (index: number, className?: string) {
      return `
      <span class="${className} !w-2 !h-2 md:!w-2 md:!h-2
       !opacity-100 bg-white
      [&.swiper-pagination-bullet-active]:bg-gray-800">
